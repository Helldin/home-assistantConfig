$(function(){ //DOM Ready
    ...
    // Initialize Widgets
        ...
        widgets["default-entre-cam"] = new baseiframe("default-entre-cam", "", "hygge", {'widget_type': 'baseiframe', 'fields': {'title': 'Entre', 'frame_src': '', 'img_src': '', 'frame_style': ''}, 'icons': [], 'static_css': {'title_style': 'color: #313131;background-color: rgba(0, 0, 0, 0.5);', 'widget_style': 'background-color: rgba(179,177,172,0.70);'}, 'css': {}, 'static_icons': [], 'use_comma': 0, 'precision': 1, 'use_hass_icon': 1, 'refresh': 1, 'entity_picture': 'http://192.168.1.121:8123/api/camera_proxy/camera.cam_entre?api_password=hell17'})
    
        widgets["default-parkering-cam"] = new baseiframe("default-parkering-cam", "", "hygge", {'widget_type': 'baseiframe', 'fields': {'title': 'Parkering', 'frame_src': '', 'img_src': '', 'frame_style': ''}, 'icons': [], 'static_css': {'title_style': 'color: #313131;background-color: rgba(0, 0, 0, 0.5);', 'widget_style': 'background-color: rgba(179,177,172,0.70);'}, 'css': {}, 'static_icons': [], 'use_comma': 0, 'precision': 1, 'use_hass_icon': 1, 'refresh': 1, 'entity_picture': 'http://192.168.1.121:8123/api/camera_proxy/camera.cam_parkering?api_password=hell17'})
    
        widgets["default-altan-cam"] = new baseiframe("default-altan-cam", "", "hygge", {'widget_type': 'baseiframe', 'fields': {'title': 'Altan', 'frame_src': '', 'img_src': '', 'frame_style': ''}, 'icons': [], 'static_css': {'title_style': 'color: #313131;background-color: rgba(0, 0, 0, 0.5);', 'widget_style': 'background-color: rgba(179,177,172,0.70);'}, 'css': {}, 'static_icons': [], 'use_comma': 0, 'precision': 1, 'use_hass_icon': 1, 'refresh': 1, 'entity_picture': 'http://192.168.1.121:8123/api/camera_proxy/camera.cam_altan?api_password=hell17'})
