...
STATUSES = {
    ...
    STATUS_OK_CHARGING:             { 'icon': 'mdi:power-plug',     'message': 'Laddar' },
    STATUS_OK_CUTTING:              { 'icon': DEFAULT_ICON,         'message': 'Klipper' },
    STATUS_OK_LEAVING:              { 'icon': DEFAULT_ICON,         'message': 'Lämmnar Basen' },
    STATUS_PAUSED:                  { 'icon': 'mdi:pause',          'message': 'Vilar' },
    STATUS_PARKED_TIMER:            { 'icon': 'mdi:timetable',      'message': 'Vilar tills timer' },
    STATUS_PARKED_PARKED_SELECTED:  { 'icon': 'mdi:sleep',          'message': 'Parkerad Manuellt' },
    STATUS_OK_SEARCHING:            { 'icon': 'mdi:magnify',        'message': 'Letar efter basen' },
    STATUS_EXECUTING_START:         { 'icon': 'mdi:dots-horizontal','message': 'Startar...' },
    STATUS_EXECUTING_STOP:          { 'icon': 'mdi:dots-horizontal','message': 'Stoppar...' },
    STATUS_EXECUTING_PARK:          { 'icon': 'mdi:dots-horizontal','message': 'Förbereder för parkering...' }
}
